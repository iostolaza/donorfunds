...
void addEmployeeHours(Employee* employee) {
    ...
    cout << "Hours added successfully for " << employee->getName() << endl;
}
...
void subtractEmployeeHours(Employee* employee) {
    ...
    cout << "Hours subtracted successfully for " << employee->getName() << endl;
}
    ...
    while (true) {
        ...
        switch (accountChoice) {
            ...
            case 2:
                ...
                break;
            case 3:
                cout << "Show Account Balance functionality not implemented yet." << endl;
                break;
            case 4:
